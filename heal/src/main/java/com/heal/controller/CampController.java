...
//	            System.out.println("### items="+items);
	...
	@RequestMapping("/camp/list/")
	  public static Map<String, Object> List(String arg[]) throws IOException {
	 	Map<String, Object> resultMap = new HashMap<>();
	 	
	 	try {
	        String urlBuilder = "http://api.visitkorea.or.kr/openapi/service/rest/GoCamping/basedList?serviceKey=8zlPEPUimdwlKj4tR1GHxBYspdzo%2FtrC6KVM3evVAhXoaySHJNby9hTKlaClH2jRoxPWtSonBIczpbubTRrbqA%3D%3D&pageNo=2&numOfRows=20&MobileOS=ETC&MobileApp=AppTest";
	        URL url = new URL(urlBuilder.toString());
	        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
	        conn.setRequestMethod("GET");
	        conn.setRequestProperty("Content-type", "application/json");
...
//          System.out.println("### items="+items);
	...
	@RequestMapping("/camp/search")
	 public static Map<String, Object> searchList(String keyword, String pageNo) throws IOException {
