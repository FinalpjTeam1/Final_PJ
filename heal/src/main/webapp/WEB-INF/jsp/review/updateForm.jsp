 ...
 <!-- Header Start -->
  ...
  <fieldset>
   ...
   <div class="form-group">
      ...
      <input type="text" class="form-control" id="re_star" name="re_star" value="${dto.re_star}" required="required">
      <small id="re_star" class="form-text text-muted"></small>
    </div>
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" id="re_content" name="re_content" value="${dto.re_content}" placeholder="솔직한 후기를 작성해주세요. (500자 이내로 작성 가능합니다.)" rows="3" maxlength="501" required="required"></textarea>
	<br>
	<br>
	<br>
	<br>
	...
	<!-- 등록 / 취소 -->
	<div class="justify-content-center text-center">
    <input type="submit" value="등록" class="button rounded-0 primary-bg text-white w-100 btn_1 boxed-btn" onclick="finalCheck()">
