                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-start">
                                  <li class="page-item"><a class="page-link" href="#"><span class="flaticon-arrow roted left-arrow"></span></a></li>
                                    <li class="page-item active"><a class="page-link" href="list"><input type="hidden" id="pageNo" name="pageNo" value="1">1</a></li>
                                    <li class="page-item"><a class="page-link" href="list/">2</a></li>
                                    <li class="page-item"><a class="page-link" href="list"><input type="hidden" id="pageNo" name="pageNo" value="3">3</a></li>
